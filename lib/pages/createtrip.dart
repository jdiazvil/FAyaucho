...
import 'predictadress.dart';
import 'selectplaces.dart';
        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              Text('Search for the destination you wish for', style: Theme.of(context).textTheme.subtitle2, )
            ],
          ),
        ),
      ),
