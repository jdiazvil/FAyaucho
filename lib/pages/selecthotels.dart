          ...
          children: <Widget>[
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text('${widget.description}', style: Theme.of(context).textTheme.headline6, textAlign: TextAlign.left,),
                  Text('Select the hotels you wish to stay in', style: Theme.of(context).textTheme.bodyText2, textAlign: TextAlign.left,),
                ],
              ),
            ),
            Padding(
