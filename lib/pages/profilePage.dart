        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text("Application Settings", style: Theme.of(context).textTheme.subtitle2),
            ),
            ListTile(
              title: Text(
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 10.0, vertical: 5.0),
              child: Text("Ajuste de cuenta", style: Theme.of(context).textTheme.subtitle2),
            ),
            ListTile(
              title: Text(
                "Cambiar clave",
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 10.0, vertical: 5.0),
              child: Text("Ayuda", style: Theme.of(context).textTheme.subtitle2),
            ),
            ListTile(
              title: Text(
                "How to ...",
            ...
            ListTile(
              ...
              onTap: () {
                _launchURL('jdiaz@gmail.com','Something_to_say_about_travex','We_look_forward_to_hearing_from_you.');
                _showToast();
              },
