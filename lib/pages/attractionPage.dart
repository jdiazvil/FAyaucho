...
class _HotelAttractionPageState extends State<HotelAttractionPage> {
  ...
  Widget build(BuildContext context) {
    String? nombre_obj = widget.obj?.name;
    if (nombre_obj == null) {
      nombre_obj = '';
    };
              ...
              return <Widget>[
                SliverAppBar(
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    title: AutoSizeText(nombre_obj!, textAlign: TextAlign.left,),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Padding(
                              ...
                              Text(placeDetail!.vicinity, style: Theme.of(context).textTheme.subtitle2,),
                            ),
                            Padding(
                            ...
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 5.0, horizontal: 10.0),
                              child: Text("Best Season to Visit", style: Theme.of(context).textTheme.subtitle2),
                            ),
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 5.0, horizontal: 10.0),
                              child: Text(
                              ...
                              children: <Widget>[
                                Row(
                                  ...
                                  children: <Widget>[
                                    Padding(
                                      padding: const EdgeInsets.symmetric(vertical: 5.0, horizontal: 10.0),
                                      child: Text("Open time", style: Theme.of(context).textTheme.subtitle2),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.symmetric(vertical: 5.0, horizontal: 10.0),
                                      child: Text(
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    Padding(
                                      padding: const EdgeInsets.symmetric(vertical: 5.0, horizontal: 10.0),
                                      child: Text("Closing time", style: Theme.of(context).textTheme.subtitle2),
                                    ),
                                    Padding(
                                      padding: const EdgeInsets.symmetric(vertical: 5.0, horizontal: 10.0),
                                      child: Text(
                            ...
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 5.0, horizontal: 10.0),
                              child: Text("Reviews", style: Theme.of(context).textTheme.subtitle2),
                            ),
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 5.0, horizontal: 10.0),
                              child: Text("Review List view builder here",
                                  style: Theme.of(context).textTheme.subtitle2), //TODO review Listview builder
                            ),
                            Divider(),
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 5.0, horizontal: 10.0),
                              child: Text("Nearby Accomodations", style: Theme.of(context).textTheme.subtitle2),
                            ),
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 5.0, horizontal: 10.0),
                              child: Text("Nearby accomodation List view builder here",
                                  style: Theme.of(context).textTheme.subtitle2), //TODO similar Listview builder
                            ),
                            Divider(),
                          ],
                        ),
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Container(
                        ...
                        Text('${(widget.obj!.priceLevel! * 100)}' + 'Rs/person', style: Theme.of(context).textTheme.bodyText2,) :
                        Text('Free Entry', style: Theme.of(context).textTheme.bodyText1,),
                      ),
                    ),
                    SizedBox(
                      child: Padding(
