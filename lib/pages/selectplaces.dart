          ...
          children: <Widget>[
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text('${widget.description!.trim()}', style: Theme.of(context).textTheme.headline6, textAlign: TextAlign.left,),
                  Text('Select the place you wish to visit', style: Theme.of(context).textTheme.bodyText2, textAlign: TextAlign.left,),
                ],
              ),
            ),
            Padding(
